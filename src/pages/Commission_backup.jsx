...
const Commission = () => {
    ...
    const handleSaveKpi = async (updatedTeam, team) => {
        ...
        try {
            const response = await fetch(`https://crmapi.devcir.co/api/sales_agents_update/${updatedTeam.id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    const handleDelete = async (team) => {
        ...
        try {
            const response = await fetch(`https://crmapi.devcir.co/api/sales_agents_delete/${deletedTeam}`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                },
