...
const Set_Contest_Combined = () => {
  ...
  //   if (!selectedTeam || filteredAgents.length == 0) return null;
  //   console.log("Agents size: " + coloredAgents.size);
  //   return (
  ...
  //         {Array.from({ length: filteredAgents.length }, (_, index) => (
  //           <div key={index} className='flex gap-[10px]'>
  //             <img
  //               src="/images/trophy.png"
  //               alt=""
  //               className={`w-[57px] h-[79px] ${index < coloredAgents.size ? 'opacity-100' : 'opacity-40'}`}
  //             />
  ...
  useEffect(() => {
    // Recalculate the total prize whenever the component re-renders
    let prizeSum = 0;
    for (let i = 0; i < coloredAgents.size; i++) {
      prizeSum += parseFloat(firstPrize) || 0; // Replace firstPrize if it's specific to each agent
    }
    setTotalPrize(prizeSum); // Update state with the new sum
  }, [coloredAgents, firstPrize]); // Dependency array ensures this effect runs when coloredAgents or firstPrize changes
  ...
  const renderTrophies = () => {
    ...
    return (
      <div className='flex flex-col w-full gap-6 p-8 pb-12 card  ml-[-30px] mt-8'>
        <div className='flex flex-wrap items-center gap-[20px] justify-evenly'>
          {Array.from({ length: filteredAgents.length }, (_, index) => {
            const isColored = index < coloredAgents.size;
            ...
            return (
              <div key={index} className='flex gap-[10px]'>
                <img
                  src="/images/trophy.png"
                  alt=""
                  className={`w-[57px] h-[79px] ${isColored ? 'opacity-100' : 'opacity-40'}`}
                />
                <div className='flex flex-col gap-[11px]'>
                  <label htmlFor={`prize${index + 1}`} className='text-sm font-normal leading-[21px] text-left text-dGreen'>
                    1st prize
                  ...
                  <input
                    type="number"
                    id={`prize${index + 1}`}
                    value={firstPrize} // Ensure this value is correct for each agent
                    placeholder="Enter prize"
                    className='bg-lGreen p-2 text-[14px] placeholder-[#8fa59c] font-[500] border-none h-[45px] w-[130px] max-sm:w-[100px]'
                    readOnly
                  />
        ...
        <>
          <div className='flex flex-col w-full gap-6 p-8 pb-12 ml-[-40px] card'>
            <div className='flex justify-center gap-[10px]'>
              ...
              <div className='flex flex-col gap-[11px]'>
                <label htmlFor='firstPrize' className='text-sm font-normal leading-[21px] text-left text-dGreen'>Prize</label>
                <input
            ...
            <div className='flex flex-wrap items-center gap-[20px] justify-between'>
              ...
              <div className='flex gap-[12px] ml-[-14px]'>
                <img src="/images/2prize.png" alt="" className='w-[57px] h-[79px] opacity-50' />
                <div className='flex flex-col gap-[11px]'>
                  ...
                  <input
                    ...
                    className='bg-lGreen p-2 text-[14px] placeholder-[#8fa59c] font-[500] border-none h-[45px] w-[130px] max-sm:w-[100px] opacity-50'
                    disabled={true}
                  />
                </div>
              </div>
              ...
              <div className='flex gap-[12px] ml-[-14px]'>
                <img src="/images/3prize.png" alt="" className='w-[57px] h-[79px] opacity-50' />
                <div className='flex flex-col gap-[11px]'>
...
>
  {team.team_name}
          ...
          {/* _______________________________ trophy div ______________________________________________ */}


          {/* {renderTrophies()} */}

          {prizeSelected && selectedTeam && (
            renderTrophies()
          )}



          {/* _____________________________ trophy div _________________________________________________ */}
...
export default Set_Contest_Combined;
