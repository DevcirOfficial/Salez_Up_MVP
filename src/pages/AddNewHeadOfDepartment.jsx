...
const AddNewHeadOfDepartment = ({ set, setter, onDepartmentHead}) => {
  ...
  useEffect(() => {
    ...
    setStartDate(today); // Set the startDate state
  }, []);
  ...
  const register_head_of_department = async (e) => {
    ...
    const responses = await fetch("https://crmapi.devcir.co/api/department-heads");
    if (!responses.ok) {
    ...
    try {
      ...
      onDepartmentHead(newDepartmentHead);
      ...
      setEmail("");
      setImageFile();
      alert("Department Head is successfully created");
    ...
    <form>
      <div className="flex flex-col w-full gap-12 p-8 pb-14 card">
        ...
        <div className="flex flex-row justify-between">
          ...
          <div className="flex flex-col w-full">
            ...
            <div className="flex flex-row ml-11 mt-[14px]">
              ...
              <div className="w-1/3  ml-11 mt-[16px]">
                <label
                  htmlFor="date"
                  className="font-medium text-[14px] text-dGreen mb-2 block"
                >
        ...
        <div className="flex justify-end mt-8">
          <button
            onClick={register_head_of_department}
