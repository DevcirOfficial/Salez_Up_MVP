...
<div className="w-full flex flex-col gap-[15px]">
  ...
  <div className="relative">
    <input
      className="w-full rounded-[6px] text-dGreen bg-lGreen p-0 py-[12px] px-[16px] font-[500] h-[45px] border-none leading-[21px] text-[14px] placeholder-[#8fa59c] pr-[40px]" // add padding for the icon space
      placeholder="Enter your Password"
      type={isPasswordVisible ? "text" : "password"}
      required
      value={password}
...
export default OpsManagerSignIn;
