...
const DialsTable = () => {
  ...
  const [leaderboardData, setLeaderboardData] = useState([
    { name: 'Abigail Walker', score: 200, image: '/images/dashboard_img1.png', badge: '/images/unicorn.png' },
    { name: 'Henry Perez', score: 190, image: '/images/dashboard_img2.png', badge: '/images/platinium.png' },
    { name: 'Lily Roberts', score: 180, image: '/images/dashboard_img3.png', badge: '/images/gold.png' },
    { name: 'Benjamin Adams', score: 160, image: '/images/dashboard_img1.png', badge: '/images/silver.png' },
    { name: 'Ella Moore', score: 140, image: '/images/dashboard_img2.png', badge: '/images/silver.png' },
    { name: 'Alexander Rivera', score: 120, image: '/images/dashboard_img3.png', badge: '/images/bronze.png' },
    { name: 'Grace Ramirez', score: 90, image: '/images/dashboard_img2.png', badge: '/images/bronze.png' },
    { name: 'Lucas Bennett', score: 80, image: '/images/dashboard_img1.png', badge: '/images/bronze.png' },
  ]);
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex-1 flex flex-col justify-center items-center text-center">
              ...
              <div className="relative flex justify-center items-center -mt-9">
                <HalfDonutChart
                  data={[100, 20]} // Progress and remaining
                  colors={["#cdec51", "#f3f4f6"]} // Progress and remaining colors
                />
            ...
            <div className="flex-1 flex flex-col justify-center items-center text-center">
              ...
              <div className="relative flex justify-center items-center -mt-9">
                <HalfDonutChart
                  data={[80, 40]} // Progress and remaining
                  colors={["#289780", "#f3f4f6"]} // Progress and remaining colors
                />
                <div className="absolute inset-3 w-full flex mt-16 flex-col justify-evenly items-center">
                  <p className="text-green-500 text-2xl font-normal">190/Day</p>
                  <div className="flex justify-between text-sm text-gray-500 w-full">
                    <span>0</span>
                    <span>250</span>
                  </div>
