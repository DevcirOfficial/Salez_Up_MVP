...
const ProductivityTable = () => {
    ...
    const [leaderboardData, setLeaderboardData] = useState([
        { name: 'Chloe Edwards', score: 200, image: '/images/dashboard_img1.png', badge: '/images/unicorn.png' },
        { name: 'Sebastian Brooks', score: 190, image: '/images/dashboard_img2.png', badge: '/images/platinium.png' },
        { name: 'Avery Bell', score: 180, image: '/images/dashboard_img3.png', badge: '/images/gold.png' },
        { name: 'Jackson Ward', score: 160, image: '/images/dashboard_img1.png', badge: '/images/silver.png' },
        { name: 'Scarlett Murphy', score: 150, image: '/images/dashboard_img2.png', badge: '/images/silver.png' },
        { name: 'Daniel Cooper', score: 120, image: '/images/dashboard_img3.png', badge: '/images/bronze.png' },
        { name: 'Aria Rogers', score: 100, image: '/images/dashboard_img2.png', badge: '/images/bronze.png' },
        { name: 'Levi Fisher', score: 80, image: '/images/dashboard_img1.png', badge: '/images/bronze.png' },
    ]);
                ...
                <div className="bg-white rounded-3xl shadow p-6 w-[50%] max-w-4xl mx-auto border-[1px] border-gray-200">
                    ...
                    <div className="flex justify-between items-center mb-3">
                        <div>
                            ...
                            <h2 className="text-xl font-bold text-green-600">$51</h2>
                        </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex-1 flex flex-col justify-center items-center text-center">
                            ...
                            <p className="text-xs text-green-600 mb-4">101% to target</p>

                            {/* Half-Donut Chart */}
                            <div className="relative flex justify-center items-center -mt-9">
                                <HalfDonutChart
                                    data={[50, 0]} // Progress and remaining
                                ...
                                <div className="absolute inset-3 w-full flex mt-16 flex-col justify-evenly items-center">
                                    <p className="text-green-500 text-2xl font-light">76%</p>
                        ...
                        <div className="flex-1 flex flex-col justify-center items-center text-center">
                            ...
                            <div className="relative flex justify-center items-center -mt-9">
                                <HalfDonutChart
                                    data={[80, 0]} // Progress and remaining
                                    colors={["#10b981", "#f3f4f6"]} // Progress and remaining colors
                                />
                                <div className="absolute inset-3 w-full flex mt-16 flex-col justify-evenly items-center">
                                    <p className="text-green-500 text-2xl font-normal">76%</p>
                                    <div className="flex justify-between text-sm text-gray-500 w-full">
                                        <span>0%</span>
                                        <span>100%</span>
                                    </div>
